...
def run_experiment(method, iteration, args, log_dir_base):
    ...
    # print(manager, method, iteration, "IN RUN EXPERIMENT")
...
def main():
    ...
    # parser = argparse.ArgumentParser(description="Run reinforcement learning experiments with PettingZoo and Stable Baselines3.")
    # Define arguments as in your script
    # args = parser.parse_args()

    # Preparing directories and setting up logging can stay the same
...
if __name__ == "__main__":
    # Optional: Setting multiprocessing start method, useful especially on Unix
